...
\begin{figure}[!htbp]
	...
	\caption{ADLS的架构图，主要由三部分组成：micro-services，ADLS Back End Cluster和ADLS GateWay Cluster，其中最核心的控制部分是Secure Store Service。(\cite{ramakrishnan2017azure}图2-2)}%TODO
	\label{fig:ADLS-arc}
\end{figure}
